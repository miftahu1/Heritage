...
const ScrollIndicator = () => (
  <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
    <div className="w-6 h-10 border-2 border-amber-200 rounded-full flex justify-center pt-1">
      <div className="w-1 h-3 bg-amber-200 rounded-full animate-bounce"></div>
    </div>
  </div>
);
    ...
    <section className="relative h-screen max-h-[800px] overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <Image
          ...
          alt="Serene lakeside view of Heritage Jaysagar restaurant at dusk"
          fill
      ...
      <div className="relative z-20 h-full flex items-center">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl">
            ...
            <h1 id="hero-heading" className="font-playfair text-5xl md:text-7xl text-white mb-6">
